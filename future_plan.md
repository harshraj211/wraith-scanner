...
- Manual Workbench now has proxy capture, local CA and scoped host certificate preparation, CONNECT scope guards, Repeater, Intruder, Decoder, Comparer, response diffs, and corpus-backed request history.
